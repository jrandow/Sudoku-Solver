...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.solveButton.clicked.connect(self.solve) #TODO: check whether that works; before: (lambda: self.solve(self.list_label))
    ...
    def load(self):
        try:
            ...
            for label, nr in zip(self.list_label, s):
                label.setText(nr)
                if int(nr) == 0:
                    label.setText("")
